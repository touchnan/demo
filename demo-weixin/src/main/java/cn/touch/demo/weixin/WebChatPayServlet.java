...
@WebServlet(name = "webchatPayServlet", urlPatterns = "/webchat/pay", loadOnStartup = 1, asyncSupported = true)
public class WebChatPayServlet extends WeixinServlet {
	private final static Logger logger = LoggerFactory.getLogger(WebChatPayServlet.class);
...
//		req.setAttribute("mweb_url", paraMap.get("mweb_url"));
		req.setAttribute("mweb_url", "http://www.163.com");

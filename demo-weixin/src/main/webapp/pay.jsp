...
<% 
	String ctn=request.getContextPath();
		...
		String nweb_url = (String) request.getAttribute("mweb_url");
...
<article class="charge">
		...
		<section class="content">
		  ...
		  <ul class="select cf">
				...
				<div class="operation"><a id="pay_link" class="btn-green weui-btn weui-btn_mini weui-btn_primary" id="getBrandWCPayRequest" href="<%=nweb_url%>">立即购买</a></div>
